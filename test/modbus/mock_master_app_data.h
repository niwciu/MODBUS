...
#include "modbus_data.h"
    ...
    extern modbus_coil_t mock_master_coil[COILS_QTY];
    extern modbus_disin_t mock_master_dis_in[DISCRET_INPUT_QTY];
    ...
    void mock_set_expected_master_coils_alternately(modbus_adr_t start_adr, modbus_data_qty_t qty, modbus_coil_t start_val);
