...
TEST_GROUP_RUNNER(Slave_RTU_test)
{
    ...
    RUN_TEST_CASE(Slave_RTU_test, GivenModbusSlaveInitAndSlaveManagerStateMachineSetToMOdbusSlaveTransmitingResponsAndRespMsgSendCbRegisteredWithMockFun2AndMockSendMsgCounterEqual0AndRespTransmisionFlagSetWhenCheckModbusRequestCalledThenMockSendMsgCounterEqual0);
    // RUN_TEST_CASE(Slave_RTU_test, GivenModbusSlaveInitAndSlaveManagerStateMachineSetToMOdbusSlaveTransmitingResponsAndRespMsgSendCbRegisteredWithMockFun2AndMockSendMsgCounterEqual0AndRespTransmisionFlagClearedWhenCheckModbusRequestCalledThenMockSendMsgCounterEqual1);
    // RUN_TEST_CASE(Slave_RTU_test, GivenModbusSlaveInitAndSlaveManagerStateMachineSetToMOdbusSlaveTransmitingResponsAndRespMsgSendCbRegisteredWithMockFun2AndMockSendMsgCounterEqual0AndRespTransmisionFlagClearedWhenCheckModbusRequestCalledTwiceThenMockSendMsgCounterEqual1);
