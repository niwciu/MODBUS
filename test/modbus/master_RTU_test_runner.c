...
TEST_GROUP_RUNNER(master_RTU)
{
   ...
   RUN_TEST_CASE(master_RTU, GivenModbusMasterInRTUmodeInitWhenModbusWriteMultipleWithProperParametersAndFreeMsgBuffersAreAvailableThenProperRequestSendToTxRxQueue);
   // RUN_TEST_CASE(master_RTU, GivenModbusMasterInRTUmodeInitWhenModbusWriteMultipleWithProperParametersAndNoFreeMsgBuffersAreAvailableThenReturnFreeQueueEmptyErr);
   // RUN_TEST_CASE(master_RTU, GivenModbusMasterInRTUmodeInitWhenModbusWriteMultipleWithWrongParametersAndFreeMsgBuffersAreAvailableThenReturnMasterReqLibError);
