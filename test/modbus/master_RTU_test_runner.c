...
TEST_GROUP_RUNNER(Master_RTU_test)
{
    ...
    if (1 <= MODBUS_MASTER_REQ_REPEAT_ON_ANY_ERROR)
    {
        ...
        RUN_TEST_CASE(Master_RTU_test, GivenModbusMasterInRTUmodeInitWhenAndAnyRequestTransmitedAndFrameErrorCatchedLessTimeThanRepeatOnErrorParamAndReqMsgRepeatedAndCorrectResponsRecivedAndRespProcessedAndNoExceptionCodeRecivedThenPushMsgBuferPtrToFreeQueue);
        RUN_TEST_CASE(Master_RTU_test, GivenModbusMasterInRTUmodeInitWhenAndAnyRequestTransmitedAndFrameErrorCatchedLessTimeThanRepeatOnErrorParamAndReqMsgRepeatedAndCorrectResponsRecivedAndRespProcessedAndNoExceptionCodeRecivedAndPushMsgBuferPtrToFreeQueueThenSetModbusMasterIdleState);
