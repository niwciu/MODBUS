...
TEST_GROUP_RUNNER(master_RTU)
{
   ...
   // RUN_TEST_CASE(master_RTU, GivenModbusMasterInRTUmodeInitWhenModbusReadHoldingRegistersAndGetAnswerBeforTimeOutThenMasterHoldingRegistersAreUpdatedWithSlaveValue);
