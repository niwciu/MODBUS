...
#include <stdbool.h>
    ...
    {
        MODBUS_INIT_OK,
        MODBUS_INIT_INVALID_ARG_ERR,
        MODBUS_INIT_DRIVER_INIT_ERR
    } e_modbus_init_t;
    /**
    ...
    typedef struct
    {
        volatile modbus_buf_t *data;    /**< Pointer to the data buffer. */
        volatile modbus_buf_size_t len; /**< Length of the data. */
    } modbus_req_resp_t;
