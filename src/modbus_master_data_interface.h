...
void __attribute__((__weak__)) modbus_master_disin_read(modbus_device_ID_t slave_adr, modbus_adr_t data_adr, modbus_coil_disin_t disin_val);
void __attribute__((__weak__)) modbus_master_disin_exception(const modbus_read_data_t *resp_data);

void __attribute__((__weak__)) modbus_master_hreg_read(modbus_device_ID_t slave_adr, modbus_adr_t data_adr, modbus_reg_t hreg_val);
void __attribute__((__weak__)) modbus_master_hreg_write(modbus_device_ID_t slave_adr, modbus_adr_t data_adr, modbus_data_qty_t reg_qty);
void __attribute__((__weak__)) modbus_master_hreg_exception(const modbus_read_data_t *resp_data);

void __attribute__((__weak__)) modbus_master_inreg_read(modbus_device_ID_t slave_adr, modbus_adr_t data_adr, modbus_reg_t inreg_val);
void __attribute__((__weak__)) modbus_master_inreg_exception(const modbus_read_data_t *resp_data);

void __attribute__((__weak__)) modbus_master_data_timeout_error(const modbus_master_error_report_t *timeout_error_rep);
void __attribute__((__weak__)) modbus_master_communication_error(const modbus_master_error_report_t *communication_error_rep);