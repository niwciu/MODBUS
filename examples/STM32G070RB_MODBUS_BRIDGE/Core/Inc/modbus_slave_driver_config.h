 ...
 * @brief Modbus slave driver hardware configuration for STM32G070RB BRIDGE.
 *        USART2: PA2=TX (AF1), PA3=RX (AF1), PA1=DE (AF1, HW control)
 *        TIM15:  APB2 — avoids conflict with the master's TIM7
 * @version 1.0.0
 * @date 2025-08-31
 *
...
/** modbus Timer configuration — TIM15 (APB2), avoids conflict with master TIM7 */
