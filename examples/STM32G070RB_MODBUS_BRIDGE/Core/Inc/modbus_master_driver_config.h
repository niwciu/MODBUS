 ...
 * @brief Modbus master driver hardware configuration for STM32G070RB BRIDGE.
 *        USART1: PB6=TX (AF0), PB7=RX (AF0), PB3=DE (AF4, HW control)
 *        TIM7:   APB1
 *        DMA1_Channel2 via DMAMUX1_Channel1, USART1_TX resource = 51
 * @version 1.0.0
 * @date 2025-08-31
 *
...
/** modbus USART configuration — USART1, GPIOB: PB6=TX(AF0), PB7=RX(AF0), PB3=DE(AF4) */
...
#define MODBUS_MASTER_USART_RX_MODE     (GPIO_MODER_MODE7_1) // PB7, AF mode
#define MODBUS_MASTER_USART_TX_MODE     (GPIO_MODER_MODE6_1) // PB6, AF mode
#if MASTER_USART_DE_HW_CONTROLL == ON
#define MODBUS_MASTER_USART_DE_MODE     (GPIO_MODER_MODE3_1) // PB3, AF mode
#else
#define MODBUS_MASTER_USART_DE_MODE     (GPIO_MODER_MODE3_0) // PB3, output mode
#endif
...
#define MODBUS_MASTER_USART_RX_AF  (0)           // AF0 = 0
#define MODBUS_MASTER_USART_TX_AF  (0)           // AF0 = 0
#if MASTER_USART_DE_HW_CONTROLL == ON
#define MODBUS_MASTER_USART_DE_AF  (GPIO_AFRL_AFSEL3_2) // AF4
#endif
