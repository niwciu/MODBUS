 ...
 * @brief Modbus master RTU driver interface for STM32G474RE BRIDGE.
 *        Hardware: USART1 (PA9/PA10/PA12) + TIM7 + DMA1_Channel1.
 *        GPIO clocks via RCC->AHB2ENR, DMA clock via RCC->AHB1ENR.
 * @version 1.0.0
 * @date 2025-08-31
 *
